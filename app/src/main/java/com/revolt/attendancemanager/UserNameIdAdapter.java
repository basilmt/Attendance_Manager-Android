...
public class UserNameIdAdapter extends RecyclerView.Adapter<UserNameIdAdapter.ViewHolder> {

    List<UserId> userList;
    OnClickListen onClickListen;
    public UserNameIdAdapter(List<UserId> userList, OnClickListen onClickListen) {
